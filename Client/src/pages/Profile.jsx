  ...
  return (
    <div>
      <div className="flex items-center justify-center">
        {/* <!--Card Container--> */}
        <div className="relative m-6 space-y-10 bg-pink-800 text-black shadow-xl rounded-2xl border border-pink-500 p-6">


          <h2 className=" mb-5 text-4xl font-bold text-center mt-4">
            My Profile
          </h2>
          <div className="flex">
            {/* left div */}
            ...
            <div className="flex justify-center items-center border flex-1">
              ...
              >
                <FormRow
                  ...
                  className="w-full p-2 border border-black-300 rounded-md placeholder:font-sans placeholder:font-light"
                  labelClass="text-xl text-black-700 font-bold capitalize"
                  readOnly={true}
                />
                <FormRow
                  type="text"
                ...
                <div className="col-span-2 flex justify-end">
                  <button
                    type="submit"
                    className="px-4 py-2 bg-green-200 text-black rounded-md hover:bg-green-200 transition-colors duration-200"
