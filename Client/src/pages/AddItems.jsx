...
const AddItems = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-red-100 p-6">
      <h4 className="font-mono mb-5 text-4xl font-bold text-center text-red">
        Add Waste Item
      </h4>
      ...
      >
        <div className="space-y-6">
          ...
          <button
            ...
            type="submit"
            className="bg-green-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline disabled:opacity-50"
          >
